...
for(var i = 0; i < val_array.length; i++)
{
	...
	if(!document.getElementById(str_att_id+id_arr[0]))
	{
		...
		ele.innerHTML="<p>"+id_arr[1]+" -> "+id_arr[0]+" -> <span class=\"view_full\" onclick=\"viewFull('"+weekday+lesson_id+id_arr[0]+"')\"><strong>Full Story</strong></span> <span class=\"close\" onclick=\"deleteStory(this)\" value=\""+str_att_id+id_arr[0]+"\" style='float: right;'><img src='X.png' alt='close' class='close_button'></span></p> ";
