...
$sql_insert = "insert into lesson(lesson_name,week_number,current_year,start_time,end_time,days,stories) values('$lesson_name',$week,$year,'$from','$to','$days_sql','$stories')";
